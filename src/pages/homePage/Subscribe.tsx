            ...
            { info ? 
                <div className="mt-[20px]">
                    <form onSubmit={submit} className="flex flex-col gap-3" action="">
                        <input type="text" placeholder="FullName" className="w-[270px] h-[38px] text-[13px] border[#00a4f2] rounded-md border-[1px] px-3 outline-none"
                        {...register("fullName")}
                         />
                         <p className="text-[8px] mt-[-10px] mb-[5px]">{errors?.fullName && errors?.fullName.message}</p>

                        <input type="email" placeholder="Email" className="w-[270px] h-[38px] text-[13px] border[#00a4f2] rounded-md border-[1px] px-3 outline-none" 
                        {...register("email")}
                        />
